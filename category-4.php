        ...
        <div class="categories" id="categories">
          <div class="container">
             <div class="row">
              ...
              <p>Šajā sadaļā atrodamās dziesmas ir paredzētas sportiska ritma noturešanai un uzmundrināšanai</p>
              <div class="col-lg-12 col-md-12">
                  
                  <?php 
                    $result = mysqli_query($conn, "SELECT * FROM music WHERE cat='Value4' "); 
